...
export const featuredProjects = [
  ...
  },
  {
    ...
    description:
      'Painel de controle em tempo real para análise de dados financeiros, utilizando WebSockets para atualizações instantâneas e visualização complexa de dados.',
    imageSrc:
