...
export const featuredProjects = [
  {
    ...
    description:
      'Arquitetura e desenvolvimento de uma plataforma de e-commerce altamente escalável, capaz de processar milhares de transações simultâneas com latência mínima.',
    imageSrc:
  ...
  },
  {
    ...
    description:
      'Painel de controle em tempo real para análise de dados financeiros, utilizando WebSockets para atualizações instântaneas e visualização complexa de dados.',
    imageSrc:
  ...
  },
  {
    ...
    description:
      'Construção de uma API RESTful segura para integração de sistemas de saúde, garantindo conformidade com padrões rigorosos de proteção de dados.',
    imageSrc:
  ...
  },
  {
    ...
    description:
      'Sistema distribuído para monitoramento e controle de milhares de dispositivos IoT em campo, com arquitetura orientada a eventos.',
    imageSrc:
  ...
  },
  {
    ...
    description:
      'Integração de modelos de linguagem (LLMs) em uma plataforma de geração de conteúdo, otimizando fluxos de trabalho editoriais automatizados.',
    imageSrc:
